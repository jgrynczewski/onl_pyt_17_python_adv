...
TEST_PAWNS_KILLING_THE_ENEMY = True  # 7
TEST_ROOKS_KILLING_THE_ENEMY = True  # 2
TEST_KNIGHTS_KILLING_THE_ENEMY = True  # 1
TEST_BISHOPS_KILLING_THE_ENEMY = True  # 3a
TEST_KINGS_KILLING_THE_ENEMY = True  # 6 krol nie musi sie przejmowac po prostu zbija (bez zmian)
TEST_QUEENS_KILLING_THE_ENEMY = True  # 4a
TEST_PAWNS_NOT_KILLING_ALLIES = True  # 5b
TEST_ROOKS_NOT_KILLING_ALLIES = True  # 2
TEST_KNIGHTS_NOT_KILLING_ALLIES = True  # 5a (uwaga na usuwanie pol zajetych przez wlasne figury)
TEST_BISHOPS_NOT_KILLING_ALLIES = True  # 3b
TEST_KINGS_NOT_KILLING_ALLIES = True  # 5b
TEST_QUEENS_NOT_KILLING_ALLIES = True  # 4b
TEST_GAME_END = True  # 8
